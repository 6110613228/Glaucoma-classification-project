...
def train_model(train, test, fold_no):
   ...
   filename = 'model/GlaucomakNN_fold_no'+str(fold_no)+'.sav'
...
plt.title('Receiver Operating Characteristic(ROC):Glaucoma and Non-Glaucoma')
plt.legend(loc="lower right")
plt.show()   # Display


# %%
model = joblib.load('model/GlaucomakNN_fold_no3.sav')
...
print("Glaucoma and Non-Glaucoma")
